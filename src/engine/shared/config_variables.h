...
MACRO_CONFIG_INT(ClHighBandwidth, cl_high_bandwidth, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Whether to use high bandwidth mode when joining a supported server")
